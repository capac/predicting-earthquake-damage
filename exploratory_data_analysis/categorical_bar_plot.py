...
list_tuple_categories = [('foundation_type', 'position'),
                         ('legal_ownership_status', 'land_surface_condition'),
...
fig.tight_layout()
fig.savefig(plot_dir / 'categorical-bar-plot-1.png', dpi=288)

list_cat = [('has_superstructure_adobe_mud', 'has_superstructure_mud_mortar_stone'),
...
for ax, col in zip(axes, list_cat):
    bar_plot(ax, train_values_df, col)
fig.tight_layout()
fig.savefig(plot_dir / 'categorical-bar-plot-2.png', dpi=288, bbox_inches='tight')
